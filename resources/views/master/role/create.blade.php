    ...
    <form method="POST" action="{{ route('master.roles.store') }}" class="form form-label-right" enctype="multipart/form-data">
        ...
        <div class="col col-md-12 pt-3">
            <div class="form-group row">
                ...
                <input class="form-control" placeholder="Roles Name" name="name" type="text" value="{{ old('name') }}">
                </div>
            </div>
                                    ...
                                    <div class=" text-center">
                                        <span class="kt-switch">
                                            <label>
                                                ...
                                                {{ old('permission_id') != null && in_array($permission->id, old('permission_id')) ? 'checked' : '' }}>
                                                <span></span>
                                            </label>
                                        </span>
                                    </div>
